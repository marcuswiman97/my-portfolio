...
export const alt = "Projekt Vita case study preview";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 860 }}>
          ...
          <div style={{ fontSize: 30, lineHeight: 1.35, color: "#bcc4c4", maxWidth: 760 }}>
            UX research about trust, communication, and nonprofit partnerships.
          </div>
        </div>
