      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10 lg:px-10 lg:py-14">
        ...
        <section className="mb-16 pt-0 sm:mb-18 sm:pt-1 md:mb-22 md:pt-2 lg:mb-28 lg:pt-4">
          <div className="mx-auto w-full max-w-[74rem]">
            <p className="mb-6 text-[11px] font-medium uppercase tracking-[0.32em] text-muted sm:mb-7 md:mb-8">
            ...
            <p className="mt-8 max-w-[40rem] text-[0.98rem] leading-7 text-[#aeb7b7] sm:mt-9 sm:text-[1rem] sm:leading-8 md:mt-10 md:max-w-[42rem] md:text-[1.05rem] lg:mt-12 lg:text-[1.125rem]">
              Stockholm-based. Focused on product clarity, structure, and
              creative thinking shaped by music.
            </p>

            <p className="mt-4 max-w-[40rem] text-[0.98rem] leading-7 text-[#aeb7b7] sm:mt-5 sm:text-[1rem] sm:leading-8 md:max-w-[42rem] md:text-[1.05rem] lg:mt-6 lg:text-[1.125rem]">
            ...
            <p className="mt-6 max-w-[46rem] text-[0.9rem] leading-7 text-[#8f9999] sm:text-[0.94rem] md:mt-7">
        ...
        >
          <div className="mx-auto mb-10 w-full max-w-[72rem] sm:mb-12 md:mb-14 lg:mb-16">
            <h2 className="text-[1.9rem] font-semibold leading-[1.06] tracking-[-0.04em] text-foreground sm:text-[2.05rem] md:text-[2.35rem] lg:text-[2.9rem]">
              Selected Work
            </h2>
          </div>
              ...
              >
                <div className="flex items-center justify-between gap-6 transition-transform duration-300 ease-in-out group-hover:translate-x-[2px] group-focus-visible:translate-x-[2px]">
                  <div className="min-w-0 flex-1">
                    <p className="mb-3 text-[11px] uppercase tracking-[0.22em] text-[#8f9999] sm:mb-4">
                    ...
                    <p className="mt-3 max-w-[42rem] pr-2 text-[0.96rem] leading-7 text-[#a7b0b0] sm:mt-4 sm:text-[0.98rem] sm:leading-7 md:max-w-[44rem] md:pr-0">
                      {project.description}
                    </p>
                  </div>
        ...
        <section id="about" className="py-20 sm:py-22 md:py-26 lg:py-34">
          <div className="mx-auto w-full max-w-[72rem]">
            <h2 className="text-[1.95rem] font-semibold leading-[1.04] tracking-[-0.045em] text-foreground sm:text-[2.2rem] md:text-[2.65rem] lg:text-[3rem]">
              About
            </h2>

            <p className="mt-12 max-w-[60rem] text-[1.03rem] leading-[1.82] text-[#b9c1c1] sm:mt-14 sm:text-[1.08rem] md:text-[1.12rem] lg:text-[1.18rem]">
            ...
            <p className="mt-10 max-w-[60rem] text-[1.03rem] leading-[1.82] text-[#b9c1c1] sm:mt-12 sm:text-[1.08rem] md:text-[1.12rem] lg:text-[1.18rem]">
            ...
            <p className="mt-8 max-w-[44rem] text-[0.9rem] leading-7 text-[#8f9999] sm:text-[0.94rem] md:mt-10">
        ...
        <section id="contact" className="py-20 sm:py-22 md:py-26 lg:py-34">
          <div className="mx-auto w-full max-w-[72rem]">
            ...
            <p className="mt-10 max-w-[40rem] text-[1rem] leading-[1.78] text-[#b9c1c1] sm:mt-12 sm:text-[1.04rem] md:text-[1.08rem]">
